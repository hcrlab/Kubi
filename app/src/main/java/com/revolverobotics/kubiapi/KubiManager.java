 ...
 * @author Oliver Rice
 */
@SuppressLint("NewApi") public class KubiManager implements BluetoothAdapter.LeScanCallback {
	...
	private static final String TAG = KubiManager.class.getName();
	...
	private KubiSearchResult lastDevice = null;
