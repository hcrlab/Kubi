...
public class Kubi extends GattInterface {
	...
	public static final int GESTURE_RIGHT = 5;
	public static final int GESTURE_FACE_DOWN = 6;
	public static final int GESTURE_FACE_UP = 7;
	public static final int GESTURE_RANDOM = 8;
	...
	private static final int MAX_PAN = 120;
	private static final int MAX_TILT = 15;
	
	private static final String TAG = Kubi.class.getName();
	...
	public void performGesture(int gesture)
	{
		...
		switch(gesture)
		{
			...
			case GESTURE_RIGHT:
				this.right();
				break;
			case GESTURE_FACE_DOWN:
				this.faceDown();
				break;
			case GESTURE_FACE_UP:
				this.faceUp();
				break;
			case GESTURE_RANDOM:
				this.randomGesture();
	...
	private void randomGesture() {
		...
		final int pan = MAX_PAN - random.nextInt(2 * MAX_PAN);
		final int tilt = MAX_TILT - random.nextInt(2 * MAX_TILT);
		Log.i(TAG, "Move to " + pan + " : " + tilt);
		this.mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
            	moveTo(pan, tilt);
