...
public class OldRobotFace extends SurfaceView implements SurfaceHolder.Callback {
	...
	private OldRobotEye left_eye;
	private OldRobotEye right_eye;
	...
	public OldRobotFace(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public OldRobotEye getLeftEye() { return this.left_eye;}
	public OldRobotEye getRightEye() { return this.right_eye;}
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		// DEFAULT VALUES HERE
		left_eye = new OldRobotEye(screenWidth * 4/16, screenHeight/3,
								DEFAULT_EYE_OUTER_RADIUS, Eye_ID.LEFT);
		right_eye = new OldRobotEye(screenWidth * 12/16, screenHeight/3,
